...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и список питомцев по фильтру.
        На данный момент фильтр может иметь либо пустое значение (получение списка всех питомцев), либо 'my_pets'
        (получение списка собственных питомцев)"""
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет на сервер запрос на удаление питомца с указанным ID и возвращает статус
        запроса и результат в формате JSON с текстом уведомления об успешном удалении.
